...
namespace TarkovMonitor
{
    public partial class MainBlazorUI : Form
    {
        ...
        private const string MapFrameInjection =
            ...
            // The site shows the search text and the chosen floor as badges on its buttons; the dock has no room for them.
            + "html body .tarkov-monitor-dock .leaflet-control-icon-search-toggle::after, html body .tarkov-monitor-dock .leaflet-control-icon-search-toggle::before, html body .tarkov-monitor-dock .leaflet-control-layers-toggle::after, html body .tarkov-monitor-dock .leaflet-control-layers-toggle::before, html body .tarkov-monitor-dock [data-badge]::after, html body .tarkov-monitor-dock [data-badge]::before { display: none !important; content: none !important; }"
            ...
            + "html body .leaflet-control-layers-expanded .leaflet-control-layers-list, html body .leaflet-control-map-settings-expanded .leaflet-control-map-settings-list, html body .leaflet-control-icon-search-expanded .leaflet-control-icon-search-list { display: block; position: fixed !important; right: 12px; left: auto !important; bottom: 68px; top: auto !important; box-sizing: border-box; width: 340px; min-width: 0; max-width: calc(100vw - 24px); height: auto !important; max-height: calc(100vh - 80px); overflow-y: auto; margin: 0 !important; padding: 10px 12px !important; background: rgba(30, 30, 30, 0.95); border: 1px solid rgba(255, 255, 255, 0.12); border-radius: 6px; box-shadow: 0 4px 16px rgba(0, 0, 0, 0.5); }"
            ...
            + "html body .leaflet-control-icon-search-list .maps-search-wrapper-task-filter-title { display: flex !important; align-items: center !important; justify-content: space-between !important; margin: 2px 0 6px !important; padding-right: 0 !important; padding-top: 6px !important; border-top: 1px solid rgba(255, 255, 255, 0.12) !important; font-size: 0.72rem !important; text-transform: uppercase !important; letter-spacing: 0.04em !important; color: rgba(255, 255, 255, 0.55) !important; }"
            ...
            + "html body .leaflet-control-icon-search-list .maps-search-task-filter-button-container { position: static !important; margin-left: auto !important; display: flex !important; gap: 4px; }"
            + "html body .leaflet-control-icon-search-list span.maps-search-wrapper-task-filter-title { margin: 0 !important; padding: 0 !important; }"
            ...
            + "html body .leaflet-control-icon-search-list .maps-search-task-list { max-height: 50vh; overflow-y: auto; padding-right: 8px; }"
            // Slim scroll bars in the panels (same as in the Maps tab panels).
            + "html body .leaflet-control-layers-list::-webkit-scrollbar, html body .leaflet-control-map-settings-list::-webkit-scrollbar, html body .leaflet-control-icon-search-list::-webkit-scrollbar, html body .maps-search-task-list::-webkit-scrollbar { width: 8px; height: 8px; }"
            + "html body .leaflet-control-layers-list::-webkit-scrollbar-track, html body .leaflet-control-map-settings-list::-webkit-scrollbar-track, html body .leaflet-control-icon-search-list::-webkit-scrollbar-track, html body .maps-search-task-list::-webkit-scrollbar-track { background: transparent; }"
            + "html body .leaflet-control-layers-list::-webkit-scrollbar-button, html body .leaflet-control-map-settings-list::-webkit-scrollbar-button, html body .leaflet-control-icon-search-list::-webkit-scrollbar-button, html body .maps-search-task-list::-webkit-scrollbar-button { display: none; width: 0; height: 0; }"
            + "html body .leaflet-control-layers-list::-webkit-scrollbar-thumb, html body .leaflet-control-map-settings-list::-webkit-scrollbar-thumb, html body .leaflet-control-icon-search-list::-webkit-scrollbar-thumb, html body .maps-search-task-list::-webkit-scrollbar-thumb { background: rgba(255, 255, 255, 0.2); border-radius: 4px; border: 2px solid transparent; background-clip: padding-box; }"
            + "html body .leaflet-control-layers-list::-webkit-scrollbar-thumb:hover, html body .leaflet-control-map-settings-list::-webkit-scrollbar-thumb:hover, html body .leaflet-control-icon-search-list::-webkit-scrollbar-thumb:hover, html body .maps-search-task-list::-webkit-scrollbar-thumb:hover { background: rgba(255, 255, 255, 0.35); background-clip: padding-box; }"
            + "html body .leaflet-control-layers-list, html body .leaflet-control-map-settings-list, html body .leaflet-control-icon-search-list, html body .maps-search-task-list { scrollbar-width: thin; scrollbar-color: rgba(255, 255, 255, 0.2) transparent; }"
