...
namespace TarkovMonitor
{
    public partial class MainBlazorUI : Form
    {
        ...
        private const string MapFrameInjection =
            ...
            + "html body .leaflet-control-map-settings-expanded .leaflet-control-map-settings-list, html body .leaflet-control-icon-search-expanded .leaflet-control-icon-search-list { position: absolute !important; left: -2px; bottom: 50px; box-sizing: border-box; width: max-content; min-width: 280px; max-width: min(420px, calc(100vw - 32px)); max-height: calc(100vh - 140px); overflow-y: auto; margin: 0 !important; padding: 10px 12px !important; background: rgba(0, 0, 0, 0.85); border: 2px solid rgba(0, 0, 0, 0.2); border-radius: 6px; box-shadow: 0 2px 6px rgba(0, 0, 0, 0.45); }"
            ...
            + "html body .leaflet-control-icon-search-expanded .maps-search-wrapper-reset-search { right: 20px !important; top: 22px !important; }"
            ...
            + "  var left = Math.round(rect.right) + 'px', gap = Math.round(rect.height + 8) + 'px', width = Math.round(rect.width + 104) + 'px';"
