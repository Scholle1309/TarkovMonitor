...
namespace TarkovMonitor
{
    public partial class MainBlazorUI : Form
    {
        ...
        private const string MapFrameInjection =
            ...
            + "html body .leaflet-control-map-settings:not(.leaflet-control-map-settings-expanded), html body .leaflet-control-map-settings-toggle { width: 44px !important; height: 44px !important; background-size: 24px 24px !important; }"
            + "html body .maps-search-wrapper:not(.leaflet-control-icon-search-expanded), html body .leaflet-control-icon-search-toggle { width: 44px !important; height: 44px !important; background-size: 24px 24px !important; }"
            ...
            + "  ['mouseenter', 'mouseleave'].forEach(function (type) { container.addEventListener(type, function (event) { event.stopImmediatePropagation(); }, true); });"
