...
namespace TarkovMonitor
{
    public partial class MainBlazorUI : Form
    {
        ...
        private const string MapFrameInjection =
            ...
            + "html body .id-wrapper { height: 44px !important; min-width: 150px; padding: 5px 12px !important; box-sizing: border-box; display: flex !important; flex-direction: column; justify-content: center; gap: 3px; }"
            ...
            + "html body .id-wrapper .session-id-container, html body .id-wrapper .session-id { font-size: 15px; font-weight: 600; line-height: 1.1; }"
